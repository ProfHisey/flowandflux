...
export const POISEUILLE_QUESTIONS: SocraticQuestion[] = [
  {
    ...
    resolution:
      'Two effects multiply. A wider tube has more area (R²) — that is the obvious part. But a wider tube also lets the fluid at the centre sit FARTHER from the drag of the walls, so the average speed itself rises as R². Area times speed gives R⁴. This is why radius is the most powerful control knob in any flow network: vessels regulate blood pressure with muscle tone rather than with the heart, and a mild-looking stenosis costs far more flow than its geometry suggests.',
  },
  {
