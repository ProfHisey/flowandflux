...
export const GASLIQUID_QUESTIONS: SocraticQuestion[] = [
  ...
  },
  {
    ...
    resolution:
      'The length of the free flight. Speeds are comparable (same T, similar masses), so D = (1/3) lambda v_bar says the whole gap lives in lambda: ~200 diameters in the gas versus a fraction of a diameter in the liquid — a factor of ~1000 in step length, times the residual speed and cage-escape statistics. Once you have seen the two trails, the four decades stop being a table entry and become geography.',
  },
];
