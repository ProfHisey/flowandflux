...
export const DIVIDER_QUESTIONS: SocraticQuestion[] = [
  ...
  {
    q: 'Set 100 cyan on the left and 100 orange on the right, then pull the divider. Each colour moves into territory that is already fully occupied by the other. Why does either of them bother?',
    resolution:
